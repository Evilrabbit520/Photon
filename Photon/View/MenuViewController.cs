...
namespace Photon.View
{
    public class MenuViewController
    {
        ...
        {
            MessageBox.Show(e.GetException().ToString(), String.Format(I18N.GetString("Photon Error: {0}"), e.GetException().Message));
        }
        ...
        private void LoadMenu()
        {
            this.contextMenu1 = new ContextMenu(new MenuItem[] {
                ...
                this.ServersItem = CreateMenuGroup("Servers", new MenuItem[] {
                    ...
                    this.ConfigItem = CreateMenuItem("Edit Photon Servers...", new EventHandler(this.Config_Click)),
        ...
        void controller_FileReadyToOpen(object sender, PhotonController.PathEventArgs e)
        {
        ...
        void controller_UpdatePACFromGFWListCompleted(object sender, GFWListUpdater.ResultEventArgs e)
        {
            ...
            ShowBalloonTip(I18N.GetString("Photon"), result, ToolTipIcon.Info, 1000);
        }
        ...
        void updateChecker_CheckUpdateCompleted(object sender, EventArgs e)
        {
            ...
            {
                ShowBalloonTip(String.Format(I18N.GetString("Photon {0} Update Found"), updateChecker.LatestVersionNumber + updateChecker.LatestVersionSuffix), I18N.GetString("Click here to update"), ToolTipIcon.Info, 5000);
            }
            else if (!_isStartupChecking)
            {
                ShowBalloonTip(I18N.GetString("Photon"), I18N.GetString("No update is available"), ToolTipIcon.Info, 5000);
            }
        ...
        {
            _notifyIcon.BalloonTipTitle = I18N.GetString("Photon is here");
            _notifyIcon.BalloonTipText = I18N.GetString("You can turn on/off Photon in the context menu");
