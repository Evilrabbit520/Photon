...
namespace Photon.Controller.Hotkeys
{
    public class HotkeyCallbacks
    {

        public static void InitInstance(PhotonController controller)
        {
            if (Instance != null)
            {
                return;
        ...
        private readonly PhotonController _controller;

        private HotkeyCallbacks(PhotonController controller)
        {
