...
using System.Timers;
using Photon.Controller.Strategy;
using Photon.Encryption;
using Photon.Encryption.AEAD;
using Photon.Encryption.Exception;
using Photon.Model;
using Photon.Proxy;
using Photon.Util.Sockets;
using static Photon.Encryption.EncryptorBase;
